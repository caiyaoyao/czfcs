package com.sz.kejin.czfcs.view;
...
public class LoadSuessView extends View {
    //绘制圆弧的进度值
    ...
    public LoadSuessView(Context context) {
        super(context);
    }

    public LoadSuessView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LoadSuessView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //设置画笔颜色
        paint.setColor(getResources().getColor(R.color.zhtColor02));
        //设置圆弧的宽度
        ...
        //根据进度画圆弧
        canvas.drawArc(rectF, 235, -360 * progress / 10, false, paint);
